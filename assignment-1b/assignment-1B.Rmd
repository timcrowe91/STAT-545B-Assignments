...
This function plots a scatter plot of two variables in a tibble

**Input (Arguments)**

- `data`: FILL_IN_WITH_DESCRIPTION
...
- `FILL_IN_ARGUMENT_NAME`: FILL_IN_WITH_DESCRIPTION
  - _Justification_: FILL_THIS_IN
- ...
kw_scater <- function(data, keyword, column, x, y, xlogscale = FALSE, ylogscale = FALSE,                             xtrim = 0, ytrim = 0, na.rm = TRUE, ...){
**Output**
...
go through function, talk about all decisions (eg why remove na's, justify error (below)) [xtrim = 20 works, but probably not what was desired]
...
kw_scatter <- function(data, keyword, column, x, y, xlogscale = FALSE, ylogscale = FALSE,                             xtrim = 0, ytrim = 0, na.rm = TRUE, ...){
...
kw_scatter(data = gapminder, keyword = "Dem.", column = country, x = lifeExp, y = gdpPercap)
...
kw_scatter(data = gapminder, keyword = "United", column = country, x = lifeExp, y = gdpPercap)

kw_scatter(vancouver_trees, "JAPANESE", common_name, date_planted, diameter, ytrim = 0.01)

kw_scatter(data = steam_games, keyword = "Action", column = genre, x = original_price, y = achievements, na.rm = FALSE)

kw_scatter(data = steam_games, keyword = "Action", column = genre, x = original_price, y = achievements, xtrim = 0.01)
...
expect_error(kw_scatter(data = gapminder, keyword = "Dem.", column = country, x = lifeExp, y = gdpPercap, xtrim = 10)) # xtrim > 1

expect_error(kw_scatter(vancouver_trees, "JAPANESE", common_name, date_planted, diameter, xtrim = 0.01)) # xtrim doesn't work for date objects

```


use expect_error for xtrim = 10, as well as for quantile w/ date
...
expect_equal(kw_scatter(data = steam_games, keyword = "Action", column = genre, x = original_price, y = achievements), kw_test)
