...
Now we have the generalized linear model, I will use the `augment()` function to show the fitted values of the model. These values are numbers between 0 and 1, corresponding to the probability given by the model that the entry belongs to `sex_group` 1 (ie the probability that the penguin is male).
