...
kw_scatter <- function(data, keyword, column, x, y, xlogscale = FALSE, ylogscale = FALSE,                             xtrim = 0, ytrim = 0){
...
kw_scatter(data = steam_games, keyword = "Action", column = genre, x = original_price, y = achievements)
