...
kw_scatter <- function(data, keyword, column, x, y, xlogscale = FALSE, ylogscale = FALSE){
...
kw_scatter(gapminder, "Dem.", country, lifeExp, gdpPercap)
kw_scatter(gapminder, "Dem.", country, lifeExp, gdpPercap, xlogscale = TRUE)
kw_scatter(gapminder, "Dem.", country, lifeExp, gdpPercap, ylogscale = TRUE)
kw_scatter(gapminder, "Dem.", country, lifeExp, gdpPercap, xlogscale = TRUE, ylogscale = TRUE)
#kw_scatter(vancouver_trees, "JAPANESE", common_name, date_planted, diameter)
...
```
  ...
  # if(xlogscale == FALSE && ylogscale == FALSE) return (data %>%
  #     filter(grepl(keyword, {{ column }})) %>%
  #     ggplot(aes({{ x }}, {{ y }})) +
  #     geom_point() +
  #     theme_bw())
  # 
  #   
  # if(xlogscale == TRUE && ylogscale == FALSE) return (data %>%
  #     filter(grepl(keyword, {{ column }})) %>%
  #     ggplot(aes({{ x }}, {{ y }})) +
  #     geom_point() +
  #     scale_x_log10() +
  #     theme_bw())
  # 
  # if(xlogscale == FALSE && ylogscale == TRUE) return (data %>%
  #     filter(grepl(keyword, {{ column }})) %>%
  #     ggplot(aes({{ x }}, {{ y }})) +
  #     geom_point() +
  #     scale_y_log10() +
  #     theme_bw())
  # 
  # if(xlogscale == TRUE && ylogscale == TRUE) return (data %>%
  #     filter(grepl(keyword, {{ column }})) %>%
  #     ggplot(aes({{ x }}, {{ y }})) +
  #     geom_point() +
  #     scale_x_log10() +
